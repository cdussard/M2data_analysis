# -*- coding: utf-8 -*-
"""
Created on Fri Aug 11 23:39:52 2023
...
path = "C:/Users/claire.dussard/OneDrive - ICM/Bureau/fig_brian/correlERD_NFperf_colorgrid/v2_brian_eachFB/true_perf_etalonnes/data/"

#cond = "main"
#sens = "neg"

# Read the CSV files
#df_global = pd.read_csv(path + "df_"+cond+"_estimate_emmeans_"+sens+".csv", header=None, delimiter=",").iloc[1:, 1:].values

#perf = "100"
cond = "mainvib"
for lim in ["0","25","50","75","100"]:
# Read the CSV files
    df_global = pd.read_csv(path + "df_"+cond+"_emmeans_"+lim+".csv", header=None, delimiter=",").iloc[1:, 1:].values
