...
contour = axs[0].contour(p_pend,levels=[0.01], colors='black', linewidths=0.6, extent=[0, 1, 0, 1], corner_mask='legacy', origin='upper') 
contour = axs[1].contour(p_main,levels=[0.01], colors='black', linewidths=0.6, extent=[0, 1, 0, 1], corner_mask='legacy', origin='upper') 
contour = axs[2].contour(p_mIll,levels=[0.01], colors='black', linewidths=0.6, extent=[0, 1, 0, 1], corner_mask='legacy', origin='upper') 
